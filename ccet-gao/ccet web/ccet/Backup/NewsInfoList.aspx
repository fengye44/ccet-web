<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ForeGroundMaster.Master"
    AutoEventWireup="true" CodeBehind="NewsInfoList.aspx.cs" Inherits="LabManage.NewsInfoList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Repeater ID="Repeater1" runat="server">
        ...
        <ItemTemplate>
            <tr>
                <td class="td_1"><a href='<%#"NewsInfo.aspx?NewsID="+Eval("NewsID")%>'> <%#Eval("NewsTitle")%></a>
                </td>
